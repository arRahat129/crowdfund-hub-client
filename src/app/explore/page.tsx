...
const campaigns = [
  { slug: "community-solar-co-op", title: "Community Solar Co-op", creator: "Mina Chen", goal: "$24,000", raised: "$18,500" },
  { slug: "riverside-food-hub", title: "Riverside Food Hub", creator: "Daniel Ortiz", goal: "$15,000", raised: "$12,100" },
  { slug: "skillshare-mobile-lab", title: "SkillShare Mobile Lab", creator: "Ava Thompson", goal: "$30,000", raised: "$22,400" }
];
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
          {campaigns.map((campaign) => (
            <Link href={`/campaigns/${campaign.slug}`} key={campaign.title}>
              <article className="rounded-3xl border border-slate-800 bg-slate-900/80 p-6 transition hover:border-cyan-400">
